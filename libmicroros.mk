...
$(EXTENSIONS_DIR)/micro_ros_src/src:
	...
	git clone -b feature/continous_fragment https://github.com/eProsima/Micro-XRCE-DDS-Client src/Micro-XRCE-DDS-Client; \
	...
	git clone -b feature/continous_fragment https://github.com/micro-ROS/rmw-microxrcedds src/rmw-microxrcedds; \
    ...
    cp -f ../Image.msg src/common_interfaces/sensor_msgs/msg/Image.msg ;
